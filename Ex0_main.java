...
import ex0.algo.OnlineElevAlgo;
...
public class Ex0_main {
    public static Long ID0=208584557L, ID1 = 318531290L, ID2 = null;
    public static void main(String[] ar) {
        ...
        OnlineElevAlgo ex0_alg = new OnlineElevAlgo(Simulator_A.getBuilding());
